...
expName = 'test-head'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\1\\Dropbox\\Termpapers\\2017-Lykyanov Evgeny\\exp_NEW\\head\\test\\categor-emot-test.psyexp',
