...
expName = 'Dense-direct-tail'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\1\\Dropbox\\Termpapers\\2017-Lykyanov Evgeny\\exp_NEW\\tail\\Dense-direct\\categor-emot-direct.psyexp',
...
Instr = visual.TextStim(win=win, name='Instr',
    ...
    font='Arial',
    units='pix', pos=[0, 0], height=22.0, wrapWidth=None, ori=0, 
