...
expName = 'Dense-opposite-tail'  # from the Builder filename that created this script
expInfo = {u'age': u'', u'session': u'21', u'participant': u'', u'name': u''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/alexeykotov/Dropbox/Termpapers/2017-Lykyanov Evgeny/exp_NEW/tail/Dense-opposite/categor-emot-opposite.psyexp',
...
trialsLoop = data.TrialHandler(nReps=10, method='random', 
